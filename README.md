...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mlforecast-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12678&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mlforecast-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mlforecast` can be installed with:

```
conda install mlforecast
```

It is possible to list all of the versions of `mlforecast` available on your platform with:
...
* [@jose-moralez](https://github.com/jose-moralez/)
